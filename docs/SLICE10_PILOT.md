...
| Fresh-history audit         | One root commit and 178 unique scannable Git objects; no excluded identity, private path, credential, database, or secret artifact found |
