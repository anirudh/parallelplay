...
Releases are published only as GitHub Release assets. npm, GitHub Packages, GHCR, automatic merge, automatic release, and automatic deployment are outside the 0.1 authority boundary.
